...
public class LittleDoorActivator extends LittleDoor {
	...
	public static class LittleDoorActivatorParser extends LittleStructureGuiParser {
		...
		public void createControls(LittlePreviews previews, LittleStructure structure) {
			...
			parent.controls.add(new GuiCheckBox("useInternalOutput", CoreControl.translate("gui.door.useInternalOutput"), 108, 103, structure instanceof LittleDoor ? !((LittleDoor) structure).useInternalOutput : false));
		...
		public LittleStructure parseStructure(LittlePreviews previews) {
			...
			GuiCheckBox useInternalOutput = (GuiCheckBox) parent.get("useInternalOutput");
			activator.useInternalOutput = !useInternalOutput.value;
