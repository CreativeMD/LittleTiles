...
public class JsonToNBTFixed
{
    ...
    {
        return new NBTException(message);
    }
    ...
    private NBTBase readListTag() throws NBTException
    {
        ...
        else
        {
            ...
            while (this.peek() != ']')
            {
                ...
                {
                    throw this.exception("Unable to insert " + NBTBase.NBT_TYPES[j] + " into ListTag of type " + NBTBase.NBT_TYPES[i]);
                }
    ...
    private <T extends Number> List<T> readArray(byte p_193603_1_, byte p_193603_2_) throws NBTException
    {
        ...
        while (true)
        {
            if (this.peek() != ']')
            {
                ...
                if (i != p_193603_2_)
                {
                    throw this.exception("Unable to insert " + NBTBase.NBT_TYPES[i] + " into " + NBTBase.NBT_TYPES[p_193603_1_]);
                }
