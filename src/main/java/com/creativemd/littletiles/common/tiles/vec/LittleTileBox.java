...
public class LittleTileBox {
	 ...
	 * @param rotation
	 * @param doubledCenter
	 *            coordinates are doubled, meaning in order to get the correct coordinates they have to be divided by two. This allows to rotate around even axis.
	 */
	 ...
	 * @param axis
	 * @param doubledCenter
	 *            coordinates are doubled, meaning in order to get the correct coordinates they have to be divided by two. This allows to flip around even axis.
	 */
