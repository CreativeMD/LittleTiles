...
public class TransformableAxisBox extends CreativeAxisAlignedBB {
	...
	public AxisAlignedBB offset(BlockPos pos) {
		return new TransformableAxisBox(box, context, this.minX + pos.getX(), this.minY + pos.getY(), this.minZ + pos.getZ(), this.maxX + pos.getX(), this.maxY + pos.getY(), this.maxZ + pos.getZ());
	}
	...
	public double calculateOffset(AxisAlignedBB other, Axis axis, double offset) {
		...
		NormalPlane[] cuttingPlanes = new NormalPlane[] { new NormalPlane(one, minOne, EnumFacing.getFacingFromAxis(AxisDirection.NEGATIVE, one)), new NormalPlane(two, minTwo, EnumFacing.getFacingFromAxis(AxisDirection.NEGATIVE,
		        two)), new NormalPlane(one, maxOne, EnumFacing.getFacingFromAxis(AxisDirection.POSITIVE, one)), new NormalPlane(two, maxTwo, EnumFacing.getFacingFromAxis(AxisDirection.POSITIVE, two)) };
