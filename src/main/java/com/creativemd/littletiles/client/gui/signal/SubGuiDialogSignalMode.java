...
public class SubGuiDialogSignalMode extends SubGui {
	...
	public final GuiSignalEvent event;
	public GuiSignalModeConfiguration config;
	public SubGuiDialogSignal dialog;
	
	public SubGuiDialogSignalMode(SubGuiDialogSignal dialog, GuiSignalEvent event) {
		this.event = event;
		this.dialog = dialog;
		this.config = event.modeConfig.copy();
	}
	...
	public void createControls() {
		...
		box.select(event.modeConfig.getMode().ordinal());
		controls.add(box);
