    ...
    protected void initTransformers() {
        addTransformer(new Transformer("net.minecraft.client.renderer.RenderGlobal") {
            ...
            public void transform(ClassNode classNode) {
                ...
                m.instructions.insertBefore(m.instructions
                    .getFirst(), new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/world/LittleAnimationHandlerClient", "renderTick", "()V", false));
                ...
                m.instructions
                    .insertBefore(first, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "onReloadRenderers", patchDESC("(Lnet/minecraft/client/renderer/RenderGlobal;)V"), false));
            }
        });
        addTransformer(new Transformer("net.minecraft.client.renderer.chunk.ChunkRenderDispatcher") {
            ...
            public void transform(ClassNode node) {
                ...
                m.instructions
                    .insertBefore(first, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "uploadChunk", patchDESC("(Lnet/minecraft/util/BlockRenderLayer;Lnet/minecraft/client/renderer/BufferBuilder;Lnet/minecraft/client/renderer/chunk/RenderChunk;Lnet/minecraft/client/renderer/chunk/CompiledChunk;D)V"), false));
            }
        });
        addTransformer(new Transformer("net.minecraft.entity.player.EntityPlayer") {
            ...
            public void transform(ClassNode node) {
                ...
                if (m != null) {
                    ...
                    m.instructions
                        .add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/common/structure/type/LittleBed", "getBedOrientationInDegrees", patchDESC("(Lnet/minecraft/entity/player/EntityPlayer;)F"), false));
            ...
            public void transform(ClassNode node) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (nextLabel && insn instanceof LabelNode) {
                        m.instructions
                            .insert(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/common/structure/type/LittleBed", "setBedDirection", patchDESC("(Lnet/minecraft/entity/Entity;)V"), false));
                        m.instructions.insert(insn, new VarInsnNode(Opcodes.ALOAD, 3));
                        break;
                    }
                    if (insn instanceof MethodInsnNode && ((MethodInsnNode) insn).owner.equals(patchDESC("org/lwjgl/opengl/GL11")) && ((MethodInsnNode) insn).name
                        .equals(patchFieldName("glRotatef")))
                        nextLabel = true;
                }
            }
        });
        addTransformer(new Transformer("net.minecraft.client.renderer.chunk.RenderChunk") {
            ...
            public void transform(ClassNode node) {
                ...
                m.instructions
                    .add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "resortTransparency", "(Lnet/minecraft/client/renderer/chunk/RenderChunk;FFFLnet/minecraft/client/renderer/chunk/ChunkCompileTaskGenerator;)V", false));
        ...
        addTransformer(new Transformer("net.minecraft.client.renderer.BufferBuilder") {
            ...
            public void transform(ClassNode node) {
                ...
                m.instructions
                    .add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "getDistanceSq", "(Ljava/nio/FloatBuffer;FFFII)F", false));
                m.instructions.add(new InsnNode(Opcodes.FRETURN));
            }
        });
            ...
            public void transform(ClassNode node) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (insn instanceof LdcInsnNode && ((LdcInsnNode) insn).cst instanceof Long) {
                        ...
                        m.instructions.insert(insn, new FieldInsnNode(Opcodes.GETSTATIC, patchDESC("net/minecraft/nbt/NBTSizeTracker"), TransformerNames
                            .patchFieldName("INFINITE", patchClassName("net/minecraft/nbt/NBTSizeTracker")), patchDESC("Lnet/minecraft/nbt/NBTSizeTracker;")));
        ...
        addTransformer(new Transformer("net.minecraftforge.common.ForgeHooks") {
            ...
            public void transform(ClassNode node) {
                ...
                m.instructions
                    .add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/common/structure/type/LittleLadder", "isLivingOnLadder", patchDESC("(Lnet/minecraft/block/state/IBlockState;Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/entity/EntityLivingBase;)Z"), false));
        ...
        addTransformer(new Transformer("net.minecraft.client.Minecraft") {
            ...
            public void transform(ClassNode node) {
                ...
                m.instructions.insertBefore(first, new VarInsnNode(Opcodes.ALOAD, 0));
                m.instructions
                    .insertBefore(first, new FieldInsnNode(Opcodes.GETFIELD, className, patchFieldName("player"), patchDESC("Lnet/minecraft/client/entity/EntityPlayerSP;")));
                m.instructions.insertBefore(first, new VarInsnNode(Opcodes.ALOAD, 0));
                m.instructions
                    .insertBefore(first, new FieldInsnNode(Opcodes.GETFIELD, className, patchFieldName("world"), patchDESC("Lnet/minecraft/client/multiplayer/WorldClient;")));
                m.instructions
                    .insertBefore(first, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/event/InputEventHandler", "onMouseWheelClick", patchDESC("(Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/world/World;)Z"), false));
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    AbstractInsnNode insn = (AbstractInsnNode) iterator.next();
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKESTATIC && ((MethodInsnNode) insn).owner
                        .equals("net/minecraftforge/common/ForgeHooks") && ((MethodInsnNode) insn).name.equals("onPickBlock") && ((MethodInsnNode) insn).desc
                            .equals(patchDESC("(Lnet/minecraft/util/math/RayTraceResult;Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/world/World;)Z"))) {
                        m.instructions
                            .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/event/InputEventHandler", "onPickBlock", patchDESC("(Lnet/minecraft/util/math/RayTraceResult;Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/world/World;)Z"), false));
                        ...
                        m.instructions
                            .insertBefore(insn, new FieldInsnNode(Opcodes.GETFIELD, className, patchFieldName("objectMouseOver"), patchDESC("Lnet/minecraft/util/math/RayTraceResult;")));
                        m.instructions.insertBefore(insn, new VarInsnNode(Opcodes.ALOAD, 0));
                        m.instructions
                            .insertBefore(insn, new FieldInsnNode(Opcodes.GETFIELD, className, patchFieldName("player"), patchDESC("Lnet/minecraft/client/entity/EntityPlayerSP;")));
                        m.instructions.insertBefore(insn, new VarInsnNode(Opcodes.ALOAD, 0));
                        m.instructions
                            .insertBefore(insn, new FieldInsnNode(Opcodes.GETFIELD, className, patchFieldName("world"), patchDESC("Lnet/minecraft/client/multiplayer/WorldClient;")));
                        break;
                    }
                }
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKESPECIAL && ((MethodInsnNode) insn).owner
                        .equals(className) && ((MethodInsnNode) insn).name.equals(clickMouse) && ((MethodInsnNode) insn).desc.equals("()V")) {
                        ...
                        m.instructions
                            .insertBefore(insn, new FieldInsnNode(Opcodes.GETFIELD, className, patchFieldName("world"), patchDESC("Lnet/minecraft/client/multiplayer/WorldClient;")));
                        m.instructions
                            .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/event/InputEventHandler", "onMouseClick", patchDESC("(Lnet/minecraft/util/math/RayTraceResult;Lnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/world/World;)Z"), false));
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKESPECIAL && ((MethodInsnNode) insn).owner
                        .equals(className) && ((MethodInsnNode) insn).name.equals(sendClickBlockToController) && ((MethodInsnNode) insn).desc.equals("(Z)V")) {
        ...
        addTransformer(new Transformer("net.optifine.DynamicLight") {
            ...
            public void transform(ClassNode node) {
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKEVIRTUAL && ((MethodInsnNode) insn).name
                        .equals(methodName) && ((MethodInsnNode) insn).owner.equals(className)) {
                        AbstractInsnNode before = insn.getPrevious().getPrevious();
                        m.instructions
                            .insert(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "onOptifineMarksChunkRenderUpdateForDynamicLights", "(Lnet/minecraft/client/renderer/chunk/RenderChunk;)V", false));
        ...
        addTransformer(new Transformer("net.optifine.ConnectedTextures") {
            ...
            public void transform(ClassNode node) {
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKEVIRTUAL && ((MethodInsnNode) insn).name
                        .equals("matchesBlockId") && ((MethodInsnNode) insn).owner.equals("net/optifine/ConnectedProperties")) {
                        m.instructions.remove(insn.getPrevious());
                        m.instructions.remove(insn.getPrevious());
                        ...
                        m.instructions
                            .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/mod/optifine/ConnectedTexturesModifier", "matches", patchDESC("(Ljava/lang/Object;Lnet/minecraft/world/IBlockAccess;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/state/IBlockState;)Z"), false));
                        m.instructions.remove(insn);
                        break;
                    }
                }
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKEVIRTUAL && ((MethodInsnNode) insn).name
                        .equals("matchesBlock") && ((MethodInsnNode) insn).owner.equals("net/optifine/ConnectedProperties")) {
                        AbstractInsnNode before = insn.getPrevious().getPrevious();
                        ...
                        m.instructions
                            .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/mod/optifine/ConnectedTexturesModifier", "matches", patchDESC("(Ljava/lang/Object;Lnet/minecraft/world/IBlockAccess;Lnet/minecraft/util/math/BlockPos;I)Z"), false));
                        m.instructions.remove(insn);
                        break;
                    }
                }
                ...
                m.instructions
                    .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/mod/optifine/ConnectedTexturesModifier", "isNeighbour", patchDESC("(Lnet/minecraft/world/IBlockAccess;Lnet/minecraft/block/state/IBlockState;Lnet/minecraft/util/math/BlockPos;)Z"), false));
                ...
                m.instructions.insertBefore(insn, new VarInsnNode(Opcodes.ALOAD, 0));
                m.instructions
                    .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/mod/optifine/ConnectedTexturesModifier", "isFullCube", patchDESC("(Lnet/minecraft/block/state/IBlockState;)Z"), false));
                m.instructions.insertBefore(insn, new JumpInsnNode(Opcodes.IFEQ, insn));
                m.instructions.insertBefore(insn, new LabelNode());
                m.instructions.insertBefore(insn, new InsnNode(Opcodes.ICONST_1));
                m.instructions.insertBefore(insn, new InsnNode(Opcodes.IRETURN));
        ...
        addTransformer(new Transformer("net.minecraft.client.multiplayer.WorldClient") {
            ...
            public void transform(ClassNode node) {
                ...
                m.instructions.insertBefore(first, new VarInsnNode(Opcodes.ALOAD, 2));
                m.instructions
                    .insertBefore(first, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/common/event/LittleEventHandler", "cancelEntitySpawn", "(Lnet/minecraft/client/multiplayer/WorldClient;ILnet/minecraft/entity/Entity;)Z", false));
                m.instructions.insertBefore(first, new JumpInsnNode(Opcodes.IFEQ, first));
                m.instructions.insertBefore(first, new LabelNode());
                m.instructions.insertBefore(first, new InsnNode(Opcodes.RETURN));
            }
        ...
        /*addTransformer(new Transformer("net.minecraft.world.World") {
            ...
            public void transform(ClassNode node) {
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof MethodInsnNode && insn.getOpcode() == Opcodes.INVOKEVIRTUAL && ((MethodInsnNode) insn).name.equals(methodName) && ((MethodInsnNode) insn).owner
                        .equals(className)) {
                        VarInsnNode before = (VarInsnNode) insn.getPrevious();
                        m.instructions
                            .insert(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/common/util/converation/ChiselAndBitsConveration", "onAddedTileEntity", patchDESC("(Lnet/minecraft/tileentity/TileEntity;)V"), false));
