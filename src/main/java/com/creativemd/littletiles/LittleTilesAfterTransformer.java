    ...
    protected void initTransformers() {
        addTransformer(new Transformer("net.minecraft.client.renderer.chunk.RenderChunk") {
            ...
            public void transform(ClassNode node) {
                ...
                node.fields
                    .add(new FieldNode(Opcodes.ACC_PUBLIC, "littleTiles", "Ljava/util/List;", "Ljava/util/List<Lcom/creativemd/littletiles/common/tileentity/TileEntityLittleTiles;>;", null));
                node.fields.add(new FieldNode(Opcodes.ACC_PUBLIC, "updateQueue", "I", null, null));
                ...
                for (Iterator iterator = m.instructions.iterator(); iterator.hasNext();) {
                    ...
                    if (insn instanceof FieldInsnNode && ((FieldInsnNode) insn).owner.equals(ownerBefore) && ((FieldInsnNode) insn).name.equals(nameBefore)) {
                        ...
                        m.instructions
                            .insertBefore(insn, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "addTileEntity", "(Ljava/util/List;Lnet/minecraft/tileentity/TileEntity;)V", false));
                        // m.instructions.insertBefore(insn, last);
                    } else if (insn instanceof MethodInsnNode && ((MethodInsnNode) insn).desc.equals(descAfter) && ((MethodInsnNode) insn).owner
                        .equals(ownerAfter) && ((MethodInsnNode) insn).name.equals(nameAfter)) {
                        ...
                        m.instructions
                            .insertBefore(before, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/creativemd/littletiles/client/render/world/LittleChunkDispatcher", "onDoneRendering", "(Lnet/minecraft/client/renderer/chunk/RenderChunk;Ljava/util/List;)V", false));
