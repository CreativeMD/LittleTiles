...
public enum LittleParticlePresets {
    ...
    SMOKE(
            1,
            5,
            new ParticleSettings(-0.08F, ColorUtils.toInt(20, 20, 20, 255), 40, 5, 0.4F, 0.6F, 0.1F, LittleParticleTexture.dust_fade_out, true),
    ...
    WATER_DROP(
            1,
            20,
            new ParticleSettings(0F, ColorUtils.toInt(0, 85, 255, 255), 40, 5, 2F, 2F, 0.3F, LittleParticleTexture.square, false),
    ...
    BIG_SMOKE(
            1,
            5,
            new ParticleSettings(-0.1F, ColorUtils.toInt(54, 54, 54, 210), 88, 10, 3F, 4F, 0.3F, LittleParticleTexture.dust_fade_out, false),
            new ParticleSpreadRandom(0.04F, 0, 0, 0.03F)),
    SAND(1, 5, new ParticleSettings(0.6F, ColorUtils.toInt(54, 54, 54, 210), 50, 8, 1, 1, 0.3F, LittleParticleTexture.dust, false), new ParticleSpreadRandom(0.1F, 0, 0, 0.03F)),
    CONFETTI(
            20,
            20,
            new ParticleSettings(0F, ColorUtils.toInt(255, 255, 255, 255), 84, 10, 0F, 1F, 2F, LittleParticleTexture.diamond, true),
